<template>
  <main class="main landing">
    <section class="home-top-smart align-center">
        <div class="home-top-bg-smart">
        ...
        <div class="container">
            ...
            <div v-show="showWelcome" class="widget-wrapper">
                <div class="widget--header align-left">
                    <h1 class="h1">Hotels up to 60% off for members and fans.</h1>
                    <div class="py-2">
                        <p class="text-gray text-xs">Login or Sign up to create a free account for un-published discounted rates.</p>
                    </div>
                </div>
            ...
            <!-- Signup Form -->
            <div v-show="showSignup && !passwordForgotted" class="widget-wrapper">
                <div class="widget--header">
            ...
            <!-- Old Search Bar -->
<!--             <div v-show="showSearchBar" class="container">
                <div class="push-90"></div>
                <div class="width-750 contain-width block-align-center">
                    <h1 class="h1">Admission travel packages with lower rates and perks.</h1>
                </div>
                <div class="push-30"></div>
                <div class="width-460 contain-width block-align-center">
                    <form class="input with-button is-large" @submit.prevent="$router.push({path: '/events', query: {search: search}})" name="search" action="/events">
                        <input id="old_input_text" type="text" v-model='search' name="search">
                        <button class="button is-large" type="submit">Search</button>
                    </form>
                </div>
                <div class="push-30"></div><a class="cta-link" href="/events"><span class="weight-medium color-brand">Show me a list of events</span><img class="img-arrow" src="../assets/img/arrow-brand.png?8f00a69afd3cf7dcfd9f8183fa87d932" alt=""></a>
            </div> -->
            <no-ssr>
    ...
    <section class="home-why color-white align-center" style="background-color:#161415;">
        <div class="push-40"></div>
        <div class="container gap-wrapper">
            <ul class="flex is-grid h-gap-30 v-gap-30 weight-light is-1-column@small-tablet">
                <li>
                    <div class="home-why-item">
                        <div class="home-why-item-image"><img class="img-home-why-1" src="../assets/img/apis/zomato.png" alt=""></div>
                        <div class="push-1"></div>
                        <a class="cta-link" href="http://help.smartstay.com"><span class="weight-light">Restaurants around the hotel</span></a>
                    </div>
                </li>
                <li>
                    <div class="home-why-item">
                        <div class="home-why-item-image"><img class="img-home-why-1" src="../assets/img/apis/uber.png" alt=""></div>
                        <div class="push-1"></div>
                        <a class="cta-link" href="http://help.smartstay.com"><span class="weight-light">Ride cost from hotel to event</span></a>
                    </div>
                </li>
                <li>
                    <div class="home-why-item">
                        <div class="home-why-item-image"><img class="img-home-why-1" src="../assets/img/apis/google.png" alt=""></div>
                        <div class="push-1"></div>
                        <a class="cta-link" href="http://help.smartstay.com"><span class="weight-light">What's around the hotel</span></a>
                    </div>
                </li>
                <li>
                    <div class="home-why-item">
                        <div class="home-why-item-image"><img class="img-home-why-1" src="../assets/img/apis/iq.png" alt=""></div>
                        <div class="push-1"></div>
                        <a class="cta-link" href="http://help.smartstay.com"><span class="weight-light">Compare rates with the best sites</span></a>
                    </div>
                </li>
            </ul>
        </div>
